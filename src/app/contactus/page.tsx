...
export default function Page(){
    ...
    const modalData = {page: "Contact Us", message: "Your message sent successfully!"}
    ...
    async function onSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
          const response = await fetch(`${process.env.NEXT_PUBLIC_DJANGO_API_ENDPOINT}/contactus/`, {
            method: 'POST',
            body: formData,
          }) 
          if (!response.ok) {
    ...
    return(
        <div className="bg-white dark:bg-gray-900 py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact Us</h2>
            <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">We are preparing our website, help us improve our service by answering a few questions!</p>
            <form action="#" ref={formref} className="space-y-8" onSubmit={onSubmit}>
                <div>
